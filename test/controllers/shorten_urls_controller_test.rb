...
class ShortenUrlsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shorten_url" do
    assert_difference('ShortenUrl.count') do
      post shorten_urls_url, params: { shorten_url: { original_url: @shorten_url.original_url, short_url: @shorten_url.short_url } }
    end
  ...
  test "should update shorten_url" do
    patch shorten_url_url(@shorten_url), params: { shorten_url: { original_url: @shorten_url.original_url, short_url: @shorten_url.short_url } }
